                ...
                <div id='plans'>
                    ...
                    <ol className='flex flex-col sm:flex-row'>
                        <li className='my-8 bg-gradient-to-b from-gray-800 to-gray-700 mr-0 sm:mr-12 p-8 rounded-xl flex-1'>
                            ...
                            <a href='/' className='bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 rounded mt-4'>You own this</a>
                            
                        </li>
                        <li className='my-8 bg-gradient-to-b from-gray-700 to-indigo-900 p-8 rounded-xl flex-1'>
                            ...
                            <ul className='mb-8'>
                                ...
                                <li>- Upgrade a server to have 20 webhooks</li>
                            </ul>
                            <a href='https://paypal.me/dorikyh/' className='bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded mt-4'>Buy Now</a>
                        </li>
                    </ol>
                </div>
            </div>
