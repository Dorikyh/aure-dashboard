    ...
    <div class="dark:bg-gray-900 text-gray-900 bg-gray-200">
      ...
      <section class="mx-6 sm:mx-14 pb-12 sm:pt-12" id="stats">
        <div class="mx-auto max-w-screen-xl py-12">
          <div class="mx-auto max-w-3xl text-center">
            <h2 class="text-5xl text-gray-900 dark:text-white sm:text-6xl font-extrabold">
              Trusted by everyone
            </h2>
        ...
        <div class="mt-0">
          <dl class="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div class="flex flex-col rounded-xl bg-indigo-200 px-4 py-8 text-center dark:bg-gray-800">
