    ...
    return (
        <footer className="bg-white shadow dark:bg-gray-800">
            <div className="w-full max-w-screen-xl mx-auto md:py-8 p-8">
                ...
                <span className="block text-sm text-gray-500 text-center dark:text-gray-400">© 2024 <a href="https://kotone.tech/" className="hover:underline">Dorikyh</a>. All Rights Reserved.</span>
            </div>
        </footer>
    );
};
